...
Route::get('/exportpdf',[App\Http\Controllers\BarangController::class,'exportpdf'])->name('exportpdf');
Route::get('/exportpd',[App\Http\Controllers\AdminController::class,'exportpd'])->name('exportpd');